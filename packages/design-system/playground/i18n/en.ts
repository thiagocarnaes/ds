...
/>`,
  ...
  componentCatalog: {
    ...
    subtitle:
      'Full reference of all exported components — API tables, copy-ready usage snippets, and interactive playgrounds.',
  ...
  foundationsPage: {
    badge: 'Design Tokens',
    title: 'Foundations',
    subtitle: 'Visual reference for all design tokens — colors, spacing, typography, motion, and more. Switch themes to see values update in real time.',
    tabs: {
      colors: 'Colors',
      gradients: 'Gradients',
      typography: 'Typography',
    ...
    sections: {
      colors: 'Color Tokens',
      gradients: 'Gradient Tokens',
      typography: 'Typography Scale',
      spacing: 'Spacing Scale',
      radius: 'Border Radius',
      shadows: 'Shadows',
      motion: 'Motion',
      motionHint: 'Click each button to preview the animation. Uses prefers-reduced-motion — durations resolve to 0ms for users who prefer reduced motion.',
      zindex: 'Z-Index Scale',
      zindexHint: 'Visual hierarchy of stacking layers from base (0) to tooltip (700).',
      borders: 'Border Widths',
    },
  },
}
