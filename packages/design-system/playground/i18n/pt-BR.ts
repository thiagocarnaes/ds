...
/>`,
  ...
  foundationsPage: {
    ...
    title: 'Fundamentos',
    subtitle: 'Referência visual de todos os tokens de design — cores, espaçamento, tipografia, motion e mais. Troque o tema para ver os valores atualizarem em tempo real.',
    tabs: {
      colors: 'Cores',
    ...
    sections: {
      colors: 'Tokens de Cor',
      gradients: 'Tokens de Gradiente',
      typography: 'Escala Tipográfica',
      spacing: 'Escala de Espaçamento',
      radius: 'Border Radius',
      shadows: 'Sombras',
      motion: 'Motion',
      motionHint: 'Clique em cada botão para visualizar a animação. Usa prefers-reduced-motion — durações resolvem para 0ms para usuários que preferem movimento reduzido.',
      zindex: 'Escala de Z-Index',
      zindexHint: 'Hierarquia visual de camadas de empilhamento de base (0) a tooltip (700).',
      borders: 'Espessuras de Borda',
    },
  },
}
